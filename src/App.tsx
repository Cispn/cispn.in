    ...
    <div className="relative min-h-screen w-full bg-[#050505] font-sans text-white overflow-hidden selection:bg-white/20 select-none">
      ...
      <div className={`relative z-10 flex min-h-screen items-center justify-center p-6 transition-all duration-1000 ${!hasEntered ? 'blur-md scale-95' : 'blur-0 scale-100'}`}>
        ...
        <div className="fixed top-8 left-8 right-8 flex justify-between items-center pointer-events-auto">
          ...
          {/* URL Bar */}
          <div className="hidden md:flex items-center gap-2.5 bg-black/40 backdrop-blur-md px-5 py-2.5 rounded-full border border-white/10 transition-all hover:bg-white/10 group cursor-default">
            {lanyard ? (
              <img src={getAvatar(lanyard)} className="w-5 h-5 rounded-full border border-white/10" alt="Profile" />
            ) : (
              <div className="w-5 h-5 rounded-full bg-white/10 animate-pulse border border-white/10" />
            )}
            <motion.div 
              variants={{
                visible: {
            ...
            >
              {"CisPn".split("").map((char, index) => (
                <motion.span
                  ...
                  className="text-[11px] font-bold tracking-[0.2em] uppercase text-neutral-400 group-hover:text-white transition-colors"
                >
                  {char}
                </motion.span>
              ))}
            ...
            <div className="flex items-center gap-4">
              <div className="bg-white/5 backdrop-blur-2xl rounded-[2.5rem] border border-white/10 pt-10 pb-6 flex flex-col items-center justify-center group flex-1 relative overflow-hidden">
                <div className="relative shrink-0">
                  ...
                  <div className={`absolute -bottom-1 -right-1 w-7 h-7 rounded-full ${lanyard ? statusColor(lanyard.discord_status) : 'bg-gray-500'}`} />
                </div>
